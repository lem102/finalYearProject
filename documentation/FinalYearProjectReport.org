...
assembly generation is interesting topic
how did i handle parsing
how does my intermediate representation work
structure of compiler in comparison to proper compiler
...
that is more understandable compared to an approach that would generate
