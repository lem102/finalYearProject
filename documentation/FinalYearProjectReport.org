...
into assembly code. This compiler has a couple of sub-requirements; it
must be written in a way that is understandable to a second year computer
science student, and it must be able to show the process that source code
goes through on its journey to becoming assembly language. 
