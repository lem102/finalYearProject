...
code was needlessly hard to understand. After the refactoring development
proceeded smoothly as I had split up the code and moved the various sections
to more relevant classes.
