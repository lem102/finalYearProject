...
I gained an understanding of how compilers can target certain CPUs or managed
environments such as the JVM (Java Virutal Machine) or CLR (Common Language
Runtime). And of course the tremendous journey that is the process of compilation
