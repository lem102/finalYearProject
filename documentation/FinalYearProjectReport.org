...
In the JPL langugage, there are expressions in a similar manner to
C-like languages. For example, the following expression will evalutate
...
The feedback I recieved can mostly be grouped into two groups. The
first feedback group concerns the usability of the product. One piece
of feedback I recieved was "It would be difficult for me to figure out
...
The second feedback group concerns problems with the compiler
itself. I recieved feedback in which more datatypes were requested,
...
[todo: Minor issue: Sentences in bold as headings for paragraphs don't look good]
