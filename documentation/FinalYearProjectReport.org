...
the best thing about the product is the fact that it contains a functional
compiler that can compile a high level language into a low level language.
in of itself this is not significant, but if you consider the fact that
it has been written in a readable way
